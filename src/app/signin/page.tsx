...
export const metadata: Metadata = {
  title: "Member Login | Kingdom Redeemed Life Ecclesia",
  description: "Login to access your member dashboard, event signups, and church resources.",
  // other metadata
};
            ...
            <div className="w-full px-4">
              <div className="shadow-three dark:bg-dark mx-auto max-w-[500px] rounded-sm bg-white px-6 py-10 sm:p-[60px]">
                ...
                <p className="text-body-color mb-11 text-center text-base font-medium">
                  Access your member dashboard, event registrations, and church resources.
                </p>
                ...
                <div className="mb-8 flex items-center justify-center">
                  ...
                  <p className="text-body-color w-full px-5 text-center text-base font-medium">
                    Or, sign in with your church email
                  </p>
                  <span className="bg-body-color/50 hidden h-[1px] w-full max-w-[70px] sm:block"></span>
                </div>
                <form>
