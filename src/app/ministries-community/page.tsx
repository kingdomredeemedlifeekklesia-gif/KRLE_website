import RelatedPost from "@/components/Sermon/RelatedPost";
import SharePost from "@/components/Sermon/SharePost";
import TagButton from "@/components/Sermon/TagButton";
...
export const metadata: Metadata = {
  title: "Ministries | Kingdom Redeemed Life Ecclesia",
  description: "Learn about our ministry teams, programs, and ways to get involved.",
  // other metadata
};
...
const BlogSidebarPage = () => {
  return (
    <>
      <section className="overflow-hidden pt-[140px] pb-[100px]">
        <div className="container">
          <div className="-mx-4 flex flex-wrap">
            <div className="w-full px-4 lg:w-8/12">
              <div>
                <div className="mb-6 inline-flex rounded-full bg-primary/10 px-4 py-2">
                  <span className="text-sm font-semibold text-primary">Ministry Spotlight</span>
                </div>
                <h1 className="mb-8 text-4xl font-bold leading-tight text-black dark:text-white md:text-5xl">
                  Explore Our Ministries and Community Teams
                </h1>
                    ...
                    <div className="mr-10 mb-5 flex items-center">
                      ...
                      <div className="w-full">
                        <span className="text-body-color mb-1 text-base font-medium">
                          By <span>Kingdom Ministry Team</span>
                        </span>
                      </div>
                    </div>
                ...
                <div>
                  <p className="text-body-color mb-10 text-base leading-relaxed font-medium sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    Discover how our ministries serve families, youth, seniors,
                    and local neighbors with compassion and Gospel-centered care.
                  </p>
                  ...
                  <p className="text-body-color mb-10 text-base leading-relaxed font-medium sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    ...
                    <span className="text-primary underline dark:text-white">
                      Join our worship and service communities
                    </span>
                    as we commit to prayer, generosity, and care for those in need.
                  </p>
                  <h3 className="font-xl mb-10 leading-tight font-bold text-black sm:text-2xl sm:leading-tight lg:text-xl lg:leading-tight xl:text-2xl xl:leading-tight dark:text-white">
                    A church family that welcomes every generation.
                  </h3>
                  <p className="text-body-color mb-10 text-base leading-relaxed font-medium sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    We offer a variety of ministries—from youth groups to senior
                    care—so everyone can find connection, hope, and spiritual growth.
                  </p>
                  <ul className="text-body-color mb-10 list-inside list-disc">
                    <li className="text-body-color mb-2 text-base font-medium sm:text-lg lg:text-base xl:text-lg">
                      Worship services, prayer nights, and discipleship classes.
                    </li>
                    <li className="text-body-color mb-2 text-base font-medium sm:text-lg lg:text-base xl:text-lg">
                      A welcoming place for families, students, and neighbors.
                    </li>
                    <li className="text-body-color mb-2 text-base font-medium sm:text-lg lg:text-base xl:text-lg">
                      Opportunities to serve the community with compassion.
                    </li>
                    <li className="text-body-color mb-2 text-base font-medium sm:text-lg lg:text-base xl:text-lg">
                      Grow in faith through Scripture, fellowship, and outreach.
                    </li>
                  </ul>
                  ...
                  <div className="items-center justify-between sm:flex">
                    <div className="mb-5">
                      ...
                      <div className="flex items-center">
                        <TagButton text="Worship" />
                        <TagButton text="Outreach" />
                        <TagButton text="Faith" />
                      </div>
                    </div>
                    <div className="mb-5">
            ...
            <div className="w-full px-4 lg:w-4/12">
              ...
              <div className="shadow-three dark:bg-gray-dark mb-10 rounded-xs bg-white dark:shadow-none">
                ...
                <ul className="p-8">
                  <li className="border-body-color/10 mb-6 border-b pb-6 dark:border-white/10">
                    <RelatedPost
                      title="Living in Purpose: Next Steps in Faith"
                  ...
                  <li className="border-body-color/10 mb-6 border-b pb-6 dark:border-white/10">
                    <RelatedPost
                      title="Practical Prayer Habits for Daily Life"
                  ...
                  <li>
                    <RelatedPost
                      title="How Our Serve Teams Reach the Community"
              ...
              <div className="shadow-three dark:bg-gray-dark mb-10 rounded-xs bg-white dark:shadow-none">
                ...
                <div className="flex flex-wrap px-8 py-6">
                  <TagButton text="Sermon" />
                  <TagButton text="Prayer" />
                  <TagButton text="Worship" />
                  <TagButton text="Community" />
                  <TagButton text="Service" />
                </div>
              </div>
