...
export const metadata: Metadata = {
  title: "Join Us | Kingdom Redeemed Life Ecclesia",
  description: "Register to become part of our church family and stay connected with upcoming events.",
  // other metadata
};
            ...
            <div className="w-full px-4">
              <div className="shadow-three dark:bg-dark mx-auto max-w-[500px] rounded-sm bg-white px-6 py-10 sm:p-[60px]">
                ...
                <p className="text-body-color mb-11 text-center text-base font-medium">
                  Create your membership to stay connected with church news and events.
                </p>
                ...
                <div className="mb-8 flex items-center justify-center">
                  ...
                  <p className="text-body-color w-full px-5 text-center text-base font-medium">
                    Or, create your account with your email
                  </p>
                  <span className="bg-body-color/50 hidden h-[1px] w-full max-w-[60px] sm:block"></span>
                </div>
                <form>
