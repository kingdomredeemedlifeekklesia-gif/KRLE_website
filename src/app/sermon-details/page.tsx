...
export const metadata: Metadata = {
  title: "Sermon Details | Kingdom Redeemed Life Ecclesia",
  description: "Detailed sermon notes, scripture reflections, and spiritual encouragement.",
  // other metadata
};
            ...
            <div className="w-full px-4 lg:w-8/12">
              <div>
                <h2 className="mb-8 text-3xl leading-tight font-bold text-black sm:text-4xl sm:leading-tight dark:text-white">
                  Finding Hope in Every Season: A Sunday Sermon
                </h2>
                    ...
                    <div className="mr-10 mb-5 flex items-center">
                      ...
                      <div className="w-full">
                        <span className="text-body-color mb-1 text-base font-medium">
                          By <span>Pastor Emily Carter</span>
                        </span>
                      </div>
                    </div>
                ...
                <div>
                  <p className="text-body-color mb-10 text-base leading-relaxed font-medium sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    In this sermon, we explore how God sustains us through every
                    season of life, bringing hope, renewal, and a deeper
                  ...
                  <p className="text-body-color mb-8 text-base leading-relaxed font-medium sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    Our community gathers around Scripture and prayer to support
                    one another through life’s challenges and celebrations.
                  </p>
                  <p className="text-body-color mb-10 text-base leading-relaxed font-medium sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    Through hearts united in worship, we discover the power of
                    God’s grace and the joy of serving others in love.
                  </p>
                  ...
                  <p className="text-body-color mb-10 text-base leading-relaxed font-medium sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                    When we trust God with our next step, we find purpose,
                    encouragement, and a faithful community to walk with us.
                  </p>
                  <ul className="text-body-color mb-10 list-inside list-disc">
                    <li className="text-body-color mb-2 text-base font-medium sm:text-lg lg:text-base xl:text-lg">
                      Seek God’s presence in every season of life.
                    </li>
                    <li className="text-body-color mb-2 text-base font-medium sm:text-lg lg:text-base xl:text-lg">
                      Trust the promise of restoration and new beginnings.
                    </li>
                    <li className="text-body-color mb-2 text-base font-medium sm:text-lg lg:text-base xl:text-lg">
                      Build community through prayer, worship, and service.
                    </li>
                    <li className="text-body-color mb-2 text-base font-medium sm:text-lg lg:text-base xl:text-lg">
                      Live your faith with compassion and gratitude.
                    </li>
                  </ul>
