...
const featuresData: Feature[] = [
  {
    ...
    paragraph:
      "Experience inspiring worship and biblical teaching that helps you connect with God and renew your spirit.",
  },
  {
    id: 2,
    ...
    title: "Triumph Tabernacle Singers (TTS)",
    paragraph:
      "Join powerful prayer gatherings and one-on-one support designed to strengthen your walk with God.",
  },
  {
    id: 3,
    ...
    title: "Media Team",
    paragraph:
      "A safe, fun, and faith-building environment for children and teenagers to learn about Jesus.",
  },
];
