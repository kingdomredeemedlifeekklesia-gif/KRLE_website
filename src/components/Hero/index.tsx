...
const Hero = () => {
  const images = [
    "/images/hero/IMG_1288img_1288.jpg",
    "/images/hero/IMG_1238img_1238.jpg",
    "/images/hero/IMG_1286img_1286.jpg",
  ];
            ...
            <div className="w-full px-4">
              <div className="mx-auto max-w-[800px] text-center">
                ...
                <p className="mb-12 text-base leading-relaxed text-white/90 sm:text-lg md:text-xl">
                 A welcoming church family where faith grows, lives are transformed, and everyone is invited to experience God's love.
                </p>
